...
#+REVEAL_HTML: <p>Projekt manipulatora 3R<br>w programie Onshape</p></div>
#+REVEAL_HTML: <div>
#+ATTR_HTML: :height 800
[[./img/manipulator.png]]
#+REVEAL_HTML: <p>Manipulator 3R<br>z elastycznym chwytakiem</p></div>
#+REVEAL_HTML: </div>
...
#+REVEAL_HTML: <p>Porównanie sterowników kinematycznych przy niewielkim ograniczeniu prędkości przegubowej</p></div>
