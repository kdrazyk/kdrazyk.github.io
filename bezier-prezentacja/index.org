...
#+options: date:nil author:nil timestamp:nil toc:nil reveal_slide_number:t num:nil reveal_width:1400 reveal_height:1000
...
* Opis matematyczny
# https://en.wikipedia.org/wiki/B%C3%A9zier_curve#/media/File:Quadratic_Beziers_in_string_art.svg
#+ATTR_HTML: :height 800
...
#+ATTR_REVEAL: :frag fade-in
Krzywe Bezier nie umożliwiają kontroli lokalnej
...
#+begin_quote
Ruchy po krzywych bezier są płynniejsze, co ogranicza drgania i zużycie części, a zwiększa wydajność i dokładność.
#+end_quote
